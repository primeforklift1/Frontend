            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item mx-3 dropdown">
                    ...
                    <div class="dropdown-menu" style="background-color: rgba(255, 255, 255, 0);">
                        <a class="dropdown-item" href="<?= base_url()?>id/"><img src="<?= base_url()?>img/id.png" alt=""></a>
                        <a class="dropdown-item" href="<?= base_url()?>cn/"><img src="<?= base_url()?>img/cn.png" alt=""></a>
                        <a class="dropdown-item" href="<?= base_url()?>jp/"><img src="<?= base_url()?>img/jp.png" alt=""></a>
                        <a class="dropdown-item" href="<?= base_url()?>gn/"><img src="<?= base_url()?>img/gn.png" alt=""></a>
                    </div>
                </li>
            </ul>
        </div>
