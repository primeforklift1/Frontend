...
<div class="container">
    ...
    <div style="text-align: right;">
        <button style="margin: 15px 0px 15px 0px;" class="btn btn-success" data-toggle="modal" data-target="#addData" onclick="setForm()">Tambah Layanan</button>
    </div>
...
<script>
    ...
    function setForm(){
        ...
        form += `
        <div class="form-group">
        <label for="translated_data_title">Judul Layanan</label>
        ...
        form += `
        <div class="form-group">
        <label for="translated_data_type">Jenis Layanan</label>
        <input type="text" class="form-control" id="translated_data_type" aria-describedby="translated_data_type" placeholder="">
        <span id="val_translated_data_type"></span>
        </div>
        `;
        form += `
        <div">
            <a class="btn btn-secondary" onclick="translator('translated_data_type')">Translate</a>
        </div>
        `;
        form += `
        <div class="form-group">
    ...
    document.addEventListener("click", function(e) {
        if (e.target && e.target.id === "tambah") {
            ...
            let translated_data_type = $("#val_translated_data_type").text()
            ...
            if(translated_data_type == ""){
                config_type = $("#translated_data_type").val()
            }else{
                config_type = translated_data_type
            }
            ...
            .then(data => {
                ...
                fetch(apiURL + '/api/service/'+id)
                    ...
                    .then(data => {
                        ...
                        $("#translated_data_title").val(data.data.title_name);
                        $("#translated_data_type").val(data.data.name);
    ...
    function hapus(id){
        console.log(id);
        // delete api service by id
        fetch(apiURL + '/admin/service/'+id, {
            method: 'DELETE',
            headers: {
                'Authorization': 'Bearer '+token,
                'Content-Type': 'application/json'
